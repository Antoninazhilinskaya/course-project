...
# создаём новый холст — 800 на 500 пикселей, где и будем рисовать игру
...
class Ball:
    ...
    def __init__(self, canvas, paddle, score, color):
        ...
        # помещаем шарик в точку с координатами 200,100
...
class Score:
    ...
    def __init__(self, canvas, color):
        ...
        self.canvas = canvas
        # создаём надпись, которая показывает текущий счёт, делаем его нужного цвета и запоминаем внутреннее имя этой надписи
...
paddle = Paddle(canvas, 'violet')
# создаём объект — зеленый шарик
